...
public interface IWorkbenchCommandConstants {
	 ...
	 * @since 3.6
	 */
	String FILE_NEW_PARM_WIZARDID = "newWizardId"; //$NON-NLS-1$
	 ...
	 * @since 3.6
	 */
	String FILE_IMPORT_PARM_WIZARDID = "importWizardId"; //$NON-NLS-1$

	/**
	 * Id for command "Export" in category "File" (value is
	 * <code>"org.eclipse.ui.file.export"</code>).
	 */
	String FILE_EXPORT = "org.eclipse.ui.file.export"; //$NON-NLS-1$
	 ...
	 * @since 3.6
	 */
	String NAVIGATE_SHOW_IN_PARM_TARGET = "org.eclipse.ui.navigate.showIn.targetId"; //$NON-NLS-1$
	 ...
	 * @since 3.6
	 */
	String WINDOW_CLOSE_PERSPECTIVE_PARM_ID = "org.eclipse.ui.window.closePerspective.perspectiveId"; //$NON-NLS-1$
	 ...
	 * @since 3.6
	 */
	String WINDOW_PREFERENCES_PARM_PAGEID = "preferencePageId"; //$NON-NLS-1$
	 ...
	 * @since 3.7
	 */
	String VIEWS_SHOW_VIEW_SECONDARY_ID = "org.eclipse.ui.views.showView.secondaryId"; //$NON-NLS-1$
	 ...
	 * @since 3.6
	 */
	String PERSPECTIVES_SHOW_PERSPECTIVE_PARM_NEWWINDOW = "org.eclipse.ui.perspectives.showPerspective.newWindow"; //$NON-NLS-1$
