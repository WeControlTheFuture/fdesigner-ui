 ...
 *******************************************************************************/
package org.fdesigner.workbench.databinding;
...
public class WorkbenchProperties {
	...
	static IValueProperty adaptedValue(final Class<?> adapter, final IAdapterManager adapterManager) {
		return org.fdesigner.workbench.databinding.typed.WorkbenchProperties.adaptedValue(adapter, adapterManager);
	}
	...
	public static IValueProperty singleSelection(String partId, boolean postSelection) {
		return org.fdesigner.workbench.databinding.typed.WorkbenchProperties.singleSelection(partId, postSelection);
	}
	...
	public static IListProperty multipleSelection(String partId, boolean postSelection) {
		return org.fdesigner.workbench.databinding.typed.WorkbenchProperties.multipleSelection(partId, postSelection);
	}
}
