...
import org.fdesigner.navigator.IExtensionActivationListener;
import org.fdesigner.navigator.IExtensionStateModel;
import org.fdesigner.navigator.IMementoAware;
import org.fdesigner.navigator.INavigatorActivationService;
import org.fdesigner.navigator.INavigatorContentDescriptor;
import org.fdesigner.navigator.INavigatorContentExtension;
import org.fdesigner.navigator.INavigatorContentService;
import org.fdesigner.navigator.INavigatorContentServiceListener;
import org.fdesigner.navigator.INavigatorDnDService;
import org.fdesigner.navigator.INavigatorFilterService;
import org.fdesigner.navigator.INavigatorPipelineService;
import org.fdesigner.navigator.INavigatorSaveablesService;
import org.fdesigner.navigator.INavigatorSorterService;
import org.fdesigner.navigator.INavigatorViewerDescriptor;
import org.fdesigner.navigator.internal.navigator.dnd.NavigatorDnDService;
import org.fdesigner.navigator.internal.navigator.extensions.ExtensionSequenceNumberComparator;
import org.fdesigner.navigator.internal.navigator.extensions.NavigatorContentDescriptor;
import org.fdesigner.navigator.internal.navigator.extensions.NavigatorContentDescriptorManager;
import org.fdesigner.navigator.internal.navigator.extensions.NavigatorContentExtension;
import org.fdesigner.navigator.internal.navigator.extensions.NavigatorViewerDescriptor;
import org.fdesigner.navigator.internal.navigator.extensions.NavigatorViewerDescriptorManager;
import org.fdesigner.navigator.internal.navigator.extensions.SafeDelegateTreeContentProvider;
import org.fdesigner.navigator.internal.navigator.extensions.StructuredViewerManager;
import org.fdesigner.navigator.internal.navigator.sorters.NavigatorSorterService;
...
public class NavigatorContentService implements IExtensionActivationListener,
	...
	private final List<INavigatorContentServiceListener> listeners = new ArrayList<>();

	/*
	 * A map of (String-based-Navigator-Content-Extension-IDs,
	 * NavigatorContentExtension-objects)-pairs
	 */
	private final Map<INavigatorContentDescriptor, NavigatorContentExtension> contentExtensions = new HashMap<>();
	...
	public String[] getVisibleExtensionIds() {
		...
		List<String> visibleExtensionIds = new ArrayList<>();
	...
	public INavigatorContentDescriptor[] getVisibleExtensions() {
		List<NavigatorContentDescriptor> visibleDescriptors = new ArrayList<>();
	...
	/* package */INavigatorContentDescriptor[] getActiveDescriptorsWithSaveables() {
		List<NavigatorContentDescriptor> result = new ArrayList<>();
	...
	public INavigatorContentDescriptor[] bindExtensions(String[] extensionIds,
		...
		Set<INavigatorContentDescriptor> boundDescriptors = new HashSet<>();
	...
	public Collection<NavigatorContentExtension> findPossibleLabelExtensions(Object anElement) {
		LinkedHashSet<NavigatorContentExtension> contributors = new LinkedHashSet<>();
	...
	public ILabelProvider[] findRelevantLabelProviders(Object anElement) {
		...
		List<ICommonLabelProvider> resultProvidersList = new ArrayList<>();
	...
	public Set<NavigatorContentExtension> findRootContentExtensions(Object anElement,
		...
		SortedSet<NavigatorContentExtension> rootExtensions = new TreeSet<>(
	...
	public Set<NavigatorContentExtension> findOverrideableContentExtensionsForPossibleChild(
			Object anElement) {
		Set<NavigatorContentExtension> overrideableExtensions = new TreeSet<>(
				ExtensionSequenceNumberComparator.INSTANCE);
	...
	public Set<INavigatorContentDescriptor> findDescriptorsByTriggerPoint(Object anElement, boolean considerOverrides) {
		...
		Set<INavigatorContentDescriptor> result = new TreeSet<>(ExtensionSequenceNumberComparator.INSTANCE);
		if (descriptor != null) {
			result.add(descriptor);
		}
	...
	private void notifyListeners(final NavigatorContentExtension aDescriptorInstance) {
		...
		final List<INavigatorContentServiceListener> failedListeners = new ArrayList<>();
	...
	private ITreeContentProvider[] extractContentProviders(
		...
		List<SafeDelegateTreeContentProvider> resultProvidersList = new ArrayList<>();
	...
	private Set<NavigatorContentExtension> extractDescriptorInstances(Set<INavigatorContentDescriptor> theDescriptors,
		...
		Set<NavigatorContentExtension> resultInstances = new TreeSet<>(ExtensionSequenceNumberComparator.INSTANCE);
