 ...
 ******************************************************************************/
package org.fdesigner.e4.ui.workbench.addons.minmax;
...
import org.fdesigner.e4.ui.workbench.addons.minmax.TrimStackIdHelper.TrimStackIdPart;
...
import org.fdesigner.e4.ui.workbench.swt.internal.workbench.swt.CSSRenderingUtils;
import org.fdesigner.e4.ui.workbench.swt.internal.workbench.swt.ShellActivationListener;
...
public class TrimStack {
	...
	private void subscribeTopicTagsChanged(
			@UIEventTopic(UIEvents.ApplicationElement.TOPIC_TAGS) org.fdesigner.services.event.Event event) {
	...
	private void handleTransientDataEvents(
			@UIEventTopic(UIEvents.ApplicationElement.TOPIC_TRANSIENTDATA) org.fdesigner.services.event.Event event) {
