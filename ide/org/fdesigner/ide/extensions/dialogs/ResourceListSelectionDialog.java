...
public class ResourceListSelectionDialog extends SelectionDialog {
	...
	/**
	 * Creates a new instance of the class. When this constructor is used to create
	 * the dialog, resources will be gathered dynamically as the pattern string is
	 * specified. Only resources of the given types that match the pattern string
	 ...
	 *
	 * @param allow <code>true</code> to include the checkbox, <code>false</code> to
	 *              omit
	 * @since 3.1
	 */
	...
	/**
	 * Use a binary search to get the first match for the patternString. This method
	 * assumes the patternString does not contain any '?' characters and that it
	 * contains only one '*' character at the end of the string.
	 */
	...
	/**
	 * Use a binary search to get the last match for the patternString. This method
	 * assumes the patternString does not contain any '?' characters and that it
	 * contains only one '*' character at the end of the string.
	 */
	...
	/**
	 * Returns whether derived resources should be shown in the list. The default is
	 * <code>false</code>.
	 *
	 ...
	 *
	 * @param show <code>true</code> to show derived resources, <code>false</code>
	 *             to hide them
	 * @since 3.1
	 */
	...
	/**
	 * The user has selected a resource and the dialog is closing. Set the selected
	 * resource as the dialog result.
	 */
	@Override
	...
	/**
	 * Use this method to further filter resources. As resources are gathered, if a
	...
	/**
	 * Refreshes the filtered list of resources. Called when the text in the pattern
	 * text entry has changed.
	 *
	 * @param force if <code>true</code> a refresh is forced, if <code>false</code>
