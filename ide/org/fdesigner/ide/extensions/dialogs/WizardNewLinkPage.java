...
public class WizardNewLinkPage extends WizardPage {
	 ...
	 *
	 * @return the link target location entered by the user. null if the user choose
	 ...
	 * @return boolean <code>true</code> if the link target type is valid and
	 ...
	 * @return boolean <code>true</code> if the link target name is valid and
	 *         <code>false</code> otherwise.
	 */
