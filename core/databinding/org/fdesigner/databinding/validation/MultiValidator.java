...
package org.fdesigner.databinding.validation;
...
import org.fdesigner.databinding.ValidationStatusProvider;
import org.fdesigner.databinding.internal.databinding.Util;
import org.fdesigner.databinding.internal.databinding.validation.ValidatedObservableList;
import org.fdesigner.databinding.internal.databinding.validation.ValidatedObservableMap;
import org.fdesigner.databinding.internal.databinding.validation.ValidatedObservableSet;
import org.fdesigner.databinding.internal.databinding.validation.ValidatedObservableValue;
import org.fdesigner.databinding.observable.ChangeEvent;
import org.fdesigner.databinding.observable.Diffs;
import org.fdesigner.databinding.observable.IChangeListener;
import org.fdesigner.databinding.observable.IObservable;
import org.fdesigner.databinding.observable.IStaleListener;
...
import org.fdesigner.databinding.observable.StaleEvent;
...
import org.fdesigner.databinding.observable.value.AbstractObservableValue;
...
public abstract class MultiValidator extends ValidationStatusProvider {
	...
	public MultiValidator(Realm realm) {
		...
		try {
			...
			targets = new WritableList<>(realm, new ArrayList<IObservable>(), IObservable.class);
	...
	protected final void revalidate() {
		...
		try {
			...
			for (Iterator<IObservable> itNew = newTargets.iterator(); itNew.hasNext();) {
	...
	private class ValidationStatusObservableValue extends AbstractObservableValue<IStatus> {
